...
if(isset($_POST['add_patient'])){
    ...
    $patient_sql = "INSERT INTO patients (user_id, patient_code, name,age,phone,email,address, doctor_id )
                    VALUES ('$user_id','$patient_code','$name','$age','$phone','$email','$address','$doctor_id')";
  ...
  <div class="sidebar">
    ...
    <div class="main">
        ...
        <div class="content">
                ...
                <form method="post">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="patient_code" placeholder="P001">
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="doctor_id">
                                ...
                                <?php $doctors=mysqli_query($conn,"SELECT doctors.doctor_id, users.name FROM doctors JOIN users ON doctors.user_id=users.id");
                    ...
                    <button name="add_patient">Save Patient</button>
                </form>
            </div>
            ...
            <?php if($tab=="list"){ ?>
            <a href="reciption_patients.php?tab=add" class="add-btn">Add New Patient</a>
            <br><br>
            ...
            <div class="table-box">
                ...
                <table>
                    ...
                    <?php $sql="SELECT * FROM patients WHERE name LIKE '%$search%'";
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="action" href="reciption_patients.php?delete=<?php echo $row['patient_id']; ?>">Delete
                            </a>
                        </td>
                    </tr>
