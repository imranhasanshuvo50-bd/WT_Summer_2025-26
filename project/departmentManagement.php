...
<body>
    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td>
                    <form method="GET">
                        <button type="submit" name="edit_department" value="<?php echo $department["department_id"]; ?>">Edit</button>
                    </form>
    ...
    <form method="POST">
        <table class="form-table">
            ...
            <tr><td colspan="2"><button type="submit" name="<?php echo $editDepartment ? "edit_department" : "add_department"; ?>"><?php echo $editDepartment ? "Save Changes" : "Add New Department"; ?></button>
                <?php if ($editDepartment): ?>
