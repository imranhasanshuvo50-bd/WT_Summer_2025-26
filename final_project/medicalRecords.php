...
<div class="container">
    ...
    <?php if (count($records) > 0) { ?>
        ...
        <?php foreach ($records as $record) { ?>
            ...
            <div class="recordBox">
                ...
                <p>
                    <b>Record ID:</b>
                    <?php echo htmlspecialchars($record["consultation_id"]); ?>
                </p>
                ...
                <p>
                    <b>Temperature:</b>
                    <?php echo htmlspecialchars($record["temperature"] ?? "N/A"); ?>
                </p>

                <p>
                    <b>Blood Pressure:</b>
                    <?php echo htmlspecialchars($record["blood_pressure"] ?? "N/A"); ?>
                </p>

                <p>
                    <b>Heart Rate:</b>
                    <?php echo htmlspecialchars($record["heart_rate"] ?? "N/A"); ?>
                </p>
    ...
    <?php } else { ?>
        ...
        <p id="noResult">No medical records found.</p>
